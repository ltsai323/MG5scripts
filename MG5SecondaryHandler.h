...
// Sun Oct 15 09:19:37 2023 by ROOT version 6.22/09
// from TTree LHEF/Analysis tree
// found on file: ../old/gjet_NLO_loop_sm_no_b_mass_CT14nnlo/Events/lowPT.root
//////////////////////////////////////////////////////////

#ifndef MG5SecondaryHandler_h
#define MG5SecondaryHandler_h
...
struct IOMgr
{
    IOMgr(
            ...
            const char* iFILE,
            const char* oFILE ) :
        ptmin(ptMIN), ptmax(ptMAX), iFile( TFile::Open(iFILE) ), oFile( new TFile(oFILE,"RECREATE") )
    {
        iTree = (TTree*) iFile->Get("LHEF");
        oFile->cd();
        oTree = new TTree("LHEF", "");
    }
    Float_t ptmin, ptmax;
    TFile* iFile;
    TFile* oFile;
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxRwgt = 27;
   ...
   MG5SecondaryHandler(TTree *tree=0);
   virtual ~MG5SecondaryHandler();
   ...
   virtual void RegNewTree(TTree* oTREE);
...
#ifdef MG5SecondaryHandler_cxx
MG5SecondaryHandler::MG5SecondaryHandler(TTree *tree) : fChain(0) 
{
...
MG5SecondaryHandler::~MG5SecondaryHandler()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MG5SecondaryHandler::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MG5SecondaryHandler::LoadTree(Long64_t entry)
{
...
void MG5SecondaryHandler::Init(TTree *tree)
{
...
void MG5SecondaryHandler::RegNewTree(TTree* oTREE)
{
   oTREE->Branch("Event_size", &Event_size,"Event_size/I");
   oTREE->Branch("Event", &Event_,"Event/I");
   oTREE->Branch("Event_fUniqueID", Event_fUniqueID,"Event_fUniqueID[Event_size]/i");
   oTREE->Branch("Event_fBits", Event_fBits,"Event_fBits[Event_size]/i");
   oTREE->Branch("Event_Number", Event_Number,"Event_Number[Event_size]/L");
   oTREE->Branch("Event_Nparticles", Event_Nparticles,"Event_Nparticles[Event_size]/I");
   oTREE->Branch("Event_ProcessID", Event_ProcessID,"Event_ProcessID[Event_size]/I");
   oTREE->Branch("Event_Weight", Event_Weight,"Event_Weight[Event_size]/D");
   oTREE->Branch("Event_ScalePDF", Event_ScalePDF,"Event_ScalePDF[Event_size]/D");
   oTREE->Branch("Event_CouplingQED", Event_CouplingQED,"Event_CouplingQED[Event_size]/D");
   oTREE->Branch("Event_CouplingQCD", Event_CouplingQCD,"Event_CouplingQCD[Event_size]/D");

   oTREE->Branch("Rwgt_size", &Rwgt_size,"Rwgt_size/I");
   oTREE->Branch("Rwgt", &Rwgt_,"Rwgt/I");
   oTREE->Branch("Rwgt_fUniqueID", Rwgt_fUniqueID,"Rwgt_fUniqueID[Rwgt_size]/i");
   oTREE->Branch("Rwgt_fBits", Rwgt_fBits,"Rwgt_fBits[Rwgt_size]/i");
   oTREE->Branch("Rwgt_Weight", Rwgt_Weight,"Rwgt_Weight[Rwgt_size]/D");

   oTREE->Branch("Particle_size", &Particle_size,"Particle_size/I");
   oTREE->Branch("Particle", &Particle_,"Particle/I");
   oTREE->Branch("Particle_fUniqueID", Particle_fUniqueID,"Particle_fUniqueID[Particle_size]/i");
   oTREE->Branch("Particle_fBits", Particle_fBits,"Particle_fBits[Particle_size]/i");
   oTREE->Branch("Particle_PID", Particle_PID,"Particle_PID[Particle_size]/I");
   oTREE->Branch("Particle_Status", Particle_Status,"Particle_Status[Particle_size]/I");
   oTREE->Branch("Particle_Mother1", Particle_Mother1,"Particle_Mother1[Particle_size]/I");
   oTREE->Branch("Particle_Mother2", Particle_Mother2,"Particle_Mother2[Particle_size]/I");
   oTREE->Branch("Particle_ColorLine1", Particle_ColorLine1,"Particle_ColorLine1[Particle_size]/I");
   oTREE->Branch("Particle_ColorLine2", Particle_ColorLine2,"Particle_ColorLine2[Particle_size]/I");
   oTREE->Branch("Particle_Px", Particle_Px,"Particle_Px[Particle_size]/D");
   oTREE->Branch("Particle_Py", Particle_Py,"Particle_Py[Particle_size]/D");
   oTREE->Branch("Particle_Pz", Particle_Pz,"Particle_Pz[Particle_size]/D");
   oTREE->Branch("Particle_E", Particle_E,"Particle_E[Particle_size]/D");
   oTREE->Branch("Particle_M", Particle_M,"Particle_M[Particle_size]/D");
   oTREE->Branch("Particle_PT", Particle_PT,"Particle_PT[Particle_size]/D");
   oTREE->Branch("Particle_Eta", Particle_Eta,"Particle_Eta[Particle_size]/D");
   oTREE->Branch("Particle_Phi", Particle_Phi,"Particle_Phi[Particle_size]/D");
   oTREE->Branch("Particle_Rapidity", Particle_Rapidity,"Particle_Rapidity[Particle_size]/D");
   oTREE->Branch("Particle_LifeTime", Particle_LifeTime,"Particle_LifeTime[Particle_size]/D");
   oTREE->Branch("Particle_Spin", Particle_Spin,"Particle_Spin[Particle_size]/D");
}

Bool_t MG5SecondaryHandler::Notify()
{
...
void MG5SecondaryHandler::Show(Long64_t entry)
{
...
Int_t MG5SecondaryHandler::Cut(Long64_t entry)
{
...
#endif // #ifdef MG5SecondaryHandler_cxx
